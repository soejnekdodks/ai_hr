...
def extract_ner_annotations(cv_data: dict) -> dict:
    ...
    return {"text": full_text, "annotations": annotations}
...
# Использование
create_ner_dataset(
    "/Users/brmstr/Repos/ai_hr/ai_hr/cv_ai/src/dataset/cv_3 (2).json",
    "/Users/brmstr/Repos/ai_hr/ai_hr/cv_ai/src/dataset/cv_upgrade.json",
)
